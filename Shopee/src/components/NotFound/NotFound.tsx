...
export default function NotFound() {
  return (
    <main className='flex h-screen w-full flex-col items-center justify-center'>
      ...
      <div className='absolute rotate-12 rounded bg-shopee px-2 text-sm text-white'>Page Not Found</div>
      <button className='mt-5'>
        ...
        >
          <span className='absolute inset-0 translate-x-0.5 translate-y-0.5 bg-shopee transition-transform group-hover:translate-y-0 group-hover:translate-x-0' />
