      ...
      <div className='mt-7'>
        <NavLink
          ...
          className={({ isActive }) =>
            ...
            // })
            {
              return `flex items-center capitalize  transition-colors ${isActive ? 'text-shopeeText' : 'text-gray-600'}`
            }
          }
        >
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            `mt-4 flex items-center capitalize transition-colors ${isActive ? 'text-shopeeText' : 'text-gray-600'}`
          }
        >
          <div className='mr-3 h-[22px] w-[22px]'>
            <img src='https://cf.shopee.vn/file/ba61750a46794d8847c3f463c5e71cc4' alt='' className='h-full w-full' />
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            `mt-4 flex items-center capitalize text-gray-600 transition-colors ${isActive ? 'text-shopeeText' : 'text-gray-600'}`
          }
        >
          <div className='mr-3 h-[22px] w-[22px]'>
